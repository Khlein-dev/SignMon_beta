...
export default function Lesson4() {
    ...
    const handleQuiz = async () => {
        await playPop();
        router.push("/lessons/quiz/quiz4");
    };

    const getTitle = () => {
        if (isIntro) return "Lesson 4 - Alpabeto";
        return `Lesson 4 - Titik ${lessonVideos[currentIndex].letter}`;
    };
            ...
            {isIntro ? (
                <View style={styles.introCard}>
                    <View style={styles.badge}>
                        <Text style={styles.badgeText}>Lesson 4</Text>
                    </View>
                    ...
                    <Text style={styles.introText}>
                        Handa ka na ba? Magsimula tayo sa titik T.
                    </Text>
